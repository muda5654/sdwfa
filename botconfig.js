module.exports = {
  Admins: ["760488915207192577", "760488915207192577"], // Admins of the bot, I don't know what this do. -Darren.
  ExpressServer: true, // If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || ">", // Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/sbySMS7m3v", // Support Server Link
  Token: process.env.Token || "OTY0MTgyMTA2NjA1NDk4MzY4.GaE3BL.if9CkNMMKqoetZpVdaRGxdno-YNLC0Mic2hFxU", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "964182106605498368", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "jhaY0qgAuHsn0HCzBRg2P2_hX4b2OVek", // Discord Client Secret
  ...
  Presence: {
    ...
    name: "я какаю не мишай", // The message shown
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "4e8e00af8c094833a094e3f1a41d6f10", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "db3b5684ca2d43adb8cb750d999b4828", // Spotify Client Secret
  },
};
